...
const SERVER_URLS := [
	"ws://5.35.127.150:8765",   # публичный игровой сервер — пробуем первым (мгновенно)
	"ws://localhost:8765",      # локальный сервер для разработки
	"ws://192.168.1.72:8765",   # основной Mac в локальной сети
]
